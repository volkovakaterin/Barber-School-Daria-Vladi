  ...
  items: [
    {
      ...
      list: [
      {
        ...
        price: { defolt: {time: '2 месяца', price: '37 000'}, group: { time: '', price: '' }, personal: { time: '', price: '' } },
        id: 'jbs96o7',
      ...
      },
      {
        ...
        price: { defolt: {time: '2 дня', price: '8 000'}, group: { time: '', price: '' }, personal: { time: '', price: '' } },
        id: 'kuv233',
      ...
      },
      {
        ...
        price: { defolt: {time: '3 дня', price: '12 750'}, group: { time: '', price: '' }, personal: { time: '', price: '' } },
        id: 'gle94fg',
      ...
      },
      {
        ...
        content: '',
        fullContent: '',
        price: { defolt: {time: '5 дней', price: '17 000'}, group: { time: '', price: '' }, personal: { time: '', price: '' } },
        id: 'wy96o3',
      ...
      },
      {
        ...
        content: 'Курс мужской мастер поможет вам овладеть основами мастерства мужской стрижки за 5 дней.',
      ...
      },
      {
        ...
        content: '',
        fullContent: '',
        price: { defolt: {time: '5 дней', price: '19 000'}, group: { time: '', price: '' }, personal: { time: '', price: '' } },
        id: 'eke9jo',
